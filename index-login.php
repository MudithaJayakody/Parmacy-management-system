	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="#" class="signin-form">
		      		<div class="form-group">
		      			<input type="text" style="color:black" class="form-control" placeholder="Username" required>
		      		</div>
	            <div class="form-group">
	          ...
	          <p class="w-100 text-center">&mdash; Or Contact Admin To Create Account &mdash;</p>
